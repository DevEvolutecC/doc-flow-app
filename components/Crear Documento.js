...
function CrearDocumento() {
  ...
  // Campos detectados simulados - Reemplazar con datos reales de tu API
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4">
      ...
      <div className="flex items-center text-sm text-gray-500 mb-4">
        <Link href="/mis-plantillas" className="hover:text-purple-600">
          Mis plantillas
        </Link>
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-purple-700">Crear archivo a partir de plantilla</h1>
        <Button
          className="bg-purple-600 hover:bg-purple-700 text-white"
          onClick={() => setIsMultipleDocsModalOpen(true)}
        >
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-4">
          ...
          <div className="mt-6 flex justify-end">
            <Button className="bg-purple-600 hover:bg-purple-700 text-white">Guardar documento</Button>
          </div>
        </div>
      </div>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-6">
            <div>
              ...
              <Button className="w-full mt-2 bg-purple-600 hover:bg-purple-700 text-white">Descargar Excel</Button>
            </div>
            ...
            <div className="flex justify-between">
              ...
              <Button className="bg-purple-600 hover:bg-purple-700 text-white">Siguiente</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
